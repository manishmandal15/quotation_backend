...
// // Final mapped object
// const customer = {
//   name: cust.name || cust.customerName || "N/A",
//   gst_no: cust.gst_no || cust.gstNumber || "",
//   cstate: cust.cstate || cust.state || "",
...
export default function PrintPage() {
  ...
  if (q) loadQuotation(q, auto); // ✔ pass directly
}, []);
//  console.log("🔵 loadQuotation CALLED with:", q, shouldAutoPrint);
