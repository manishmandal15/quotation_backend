...
//     },
//     { title: "Quotation Noooooooooooooooooooooooo", dataIndex: "quotation_no" },
...
import React, { useEffect, useState } from "react";
import AddCustomer from "./addcustomer"; // path check kar lena
    ...
    {currencies.map((c) => (
      <Select.Option key={c.id} value={c.id}>
        {c.name}
           ...
           <Button
  type="dashed"
  htmlType="button"   // 🔥 MOST IMPORTANT
  onClick={() => {
...
>
        ...
        <Form
          ...
          onFinish={async (values) => {
            try {
              ...
              await PRODUCT_API.post("/", formData, {
              ...
              fetchProducts(); // 🔥 dropdown refresh
            } catch (err) {
              console.error(err);
  ...
  onClose={() => {
    ...
    fetchCustomers(); // 🔥 naya customer turant dropdown me aa jaayega
  }}
/>
